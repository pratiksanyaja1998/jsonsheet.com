...
import { Layout, Icon, ProductCard } from '../components';
import _ from 'lodash';
import { sourcebitDataClient } from 'sourcebit-target-next';
import { HR_TEAMS_ABILITIES_LIST, HR_TEAMS_TEMPLATES_LIST, HR_TEAMS_FEATURE_LIST } from '../../data';
            ...
            <div id="hrTeams">
                ...
                <section className="abilities-section py-5">
                    ...
                    <div className="container grid grid-gap-small my-2">
                        {HR_TEAMS_ABILITIES_LIST.map((item, i) => {
                            return (
