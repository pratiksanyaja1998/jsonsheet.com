...
export default class TypeHeroSection extends React.Component {
    render() {
        ...
        let subStr = title.substring(0, 22);
        let secStr = title.substring(22);
        let newStr = 'Smart Spreadsheet';
        let textArray = [secStr, newStr];
