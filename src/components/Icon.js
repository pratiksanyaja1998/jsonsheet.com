    ...
    render() {
        ...
        switch (icon) {
            ...
            case 'arrow-down':
                return (
        //        
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style={{alignSelf:"center"}}>
                        <path d="M6 9l6 6 6-6"/>
                    </svg>
                 );
            case 'arrow-right':
